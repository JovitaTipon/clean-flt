...
<head>
  ...
  <style>
    ...
    .left-side{
      flex:1; position:relative; background:#0b102f;
    ...
    .brand{
      ...
      color:#fff; font-size:1.1rem; opacity:.9;
    }
    ...
    .login-form-box{
      width:420px; max-width:94vw; background:#fff;
      border:1px solid var(--kaya-border); border-radius:1rem;
      box-shadow:0 14px 40px rgba(2,6,23,.08); padding:1.75rem 1.5rem 2rem;
    }
    .login-title{
      font-weight:800; color:var(--kaya-ink);
      font-size:1.75rem; line-height:1.2; text-align:center; margin:0 0 1rem;
    }
    ...
    .kaya-ctrl .right-icon{
      position:absolute; right:.6rem; top:50%; transform:translateY(-50%);
      width:1.25rem; text-align:center; color:#6b7280; cursor:pointer;
    }
    .kaya-input, .kaya-select{
      width:100%; border:none; outline:0; background:transparent;
      padding:.8rem .9rem .7rem 2.2rem; border-radius:.6rem; font-size:1rem; color:#111827;
    }
    .kaya-input:focus, .kaya-select:focus{ box-shadow:inset 0 0 0 2px rgba(0,0,71,.08); }
    select.kaya-select{ appearance:none; -webkit-appearance:none; -moz-appearance:none; padding-right:2.1rem; }
    .kaya-ctrl.select .right-icon{ pointer-events:none; }

    /* Button */
    .btn-kaya-primary{
      display:block; width:100%; background:var(--kaya-nav); border:1px solid var(--kaya-nav);
...
<body class="split-container">
  ...
  <aside class="left-side">
    <div class="left-content">
      ...
      <h1 class="hero-title">Smart Fleet <br>Management</h1>
      <p class="hero-sub">Book trips, manage vehicles and drivers, and keep everything moving—smoothly.</p>
    </div>
  </aside>
      ...
      <form action="login-process.php" method="post" autocomplete="off">
        ...
        <div class="kaya-field">
          ...
          <div class="kaya-ctrl">
            ...
            <input type="email" class="kaya-input" id="email" name="email" required placeholder="you@example.com">
          </div>
        </div>
        ...
        <div class="kaya-field">
          ...
          <div class="kaya-ctrl select">
            <i class="fas fa-user-shield left-icon"></i>
            <select class="kaya-select" id="user_type" name="user_type" required>
